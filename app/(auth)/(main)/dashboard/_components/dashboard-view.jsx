            ...
            <div className='grid grid-cols-1 md:grid-cols-2  gap-4'>
                <Card>
                    <CardHeader className=''>
                        ...
                        <CardDescription className="text-xs text-muted-foreground">Current trends shaping the industry</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader className=''>
                        ...
                        <CardDescription className="text-xs text-muted-foreground">Skills to consider developing</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div>
